...
3. complex()   function
What  does  complex(3 , 4)  do  ?  --->  Returns  3 + 4j
What  does  complex(3.8)  do ?     --->  Returns  3.8 + 0j
What  does  complex('9.5')  do ?   --->  Returns  9.5 + 0j
Is  complex(3 , '4')  valid ?      ---> No  becoz  2nd  arg  can  not  be  a  string
In  other  words,  arg1  can  be  a  string  but  not  arg2
Is  complex('3' , 4)  valid ?      ---> No  becoz  2nd  argument  is  not  permitted  when  1st  argument  is  a  string


4.#complex()  function  demo  program
