...
try: # error , try cannot be used without either except suite, finally suite or both
	print('Hyd')
	print('Sec')
	print('Cyb')
...
# Identify  error  (Home  work)
except: # error , except suite cannot be used without try suite
        print('Hyd')
        print('Sec')
        print('Cyb')
...
try:
	print('try suite')
except: # error , default except has to used at the end
...
except: # error , there can only be one default except
...
print(float('25')) # 25.0 
print(int(10.8)) # 10
print(math . sqrt(-25)) # error , sqrt of negative number cannot be determined
...
s = {10 , 20 , 15 , 18}
print(s[0]) # 10
b = {[10 , 20] : [30 , 40]} # error , dictionary key cannot be a mutable object
...
print('Hyd'[1]) # y
print('Hyd'[2]) # d
print('Hyd'[3]) # error , index
list = [10 , 20 , 15 , 18]
print(list[0]) # 10
print(list[3]) # 18
print(list[4]) # error , index
print(list[-1]) # 18
print(list[-4]) # 10
print(list[-5]) # error , index
tpl = (10 , 20 , 30)
print(tpl[3]) # 30
r = range(10)
print(r[10]) # error , index
s = {10 , 20 , 15 , 18}
print(s[4]) # error
d = {10 : 'Hyd' , 20 : 'Sec'}
print(d[0]) # error , key
...
What  are   the  outputs  if  input  is  4 ?  ---> Invalid value (or) operend

What  are   the  outputs  if  input  is  5 ?  ---> Object does not exist

What  are   the  outputs  if  input  is  6 ?  ---> Div by 0 is not allowed

What  are   the  outputs  if  input  is  7 ?  ---> Invalid value (or) operend
...
'''
f1 function
Caught ValueError outside the function
f1 function
'''
...
Begin
f1 function
Caught TypeError outside the function
End
'''
...
child . start()
'''
child thread 10 times (maybe not all at once)
main thread 10 times (maybe not all at once)
(inter locking)
outputs vary each time the program is executed
'''