...
g = range(5)
print('-' . join(g))
[12:20 PM, 3/7/2026] SRINIVAS Sir Maths: #  Case  conversion  methods  (Home  work)
a = 'hyD  iS  grEen  cITy'
print(a . upper())
print(a . lower())
print(a . capitalize())
...
'''
[12:39 PM, 3/7/2026] SRINIVAS Sir Maths: # islower()  method  demo  program  (Home  work)
print('hyD' . islower())
print('hyd' . islower())
print('9247' . islower())
...
Note:
1) W…
[1:01 PM, 3/7/2026] SRINIVAS Sir Maths: # Find  outputs  (Home  work)
a , b , c = 25 , 10.8 , 'Hyd'
...
[1:09 PM, 3/7/2026] SRINIVAS Sir Maths: Write  a  program  to  determine  user  input  is  alphabet , digit , white space  or  special  character
...
'''
[1:11 PM, 3/7/2026] SRINIVAS Sir Maths: '''
...
2)   H       y      d
  ...
  ---------------------------------------------
'''
[1:14 PM, 3/7/2026] SRINIVAS Sir Maths: '''
...
3) i        b[-i]           c
   ...
   -------------------------------------------------------
'''
[1:16 PM, 3/7/2026] SRINIVAS Sir Maths: '''
...
'''
[1:17 PM, 3/7/2026] SRINIVAS Sir Maths: '''
Write  a  program  to  sort  string  in  alphabetical  order

Let  input  be  RAJESH
What  is  the  output ?  --->  AEHJRS
'''
[1:20 PM, 3/7/2026] SRINIVAS Sir Maths: '''
