...
child . join(10)     #  main thread goes under waiting statefor 10 sec's or untill termination of child ,in other words which ever come first  
...
print(name , 'is ended')# if we comented  'main . join()' then  output is MainThread is ended
