...
print(range(4) | range(5))  #error-range object cannot be added using + or |
print([10 , 20]  |  [30 , 20])  #error-lists can be added using +
...
# Find outputs
print(7 / 0)  #error-divided by zero
print(7 // 0)  #error-divided by zero
print(7 % 0)  #error-divided by zero
...
print(3 + 4 * 5 - 32 / 2 ** 3)  #19   3 + 4 * 5- 32/8->3 + 20 - 4->19
...
print(10 == 10.0)  #True
print(3 + 4j >  3 + 4j)  #error-cannot be compared
...
i = not  i > 14  
print(i)  #True
print(not(6 < 4  or  9 >= 5  and  6 != 6))  #    not(False or True and False)->not(False)->True
...
a = 25
print(a)  #25
b =  a  #ref a is assigned to ref b
print(b)  #25
print(a  is  b)  #True
x = 4
y = 5
...
print(z)  #34
25 = a  #error-op1 must be a ref in assignment statement
a + b = x + y  #error-op1 cannot be an object
...
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 3 , 4]
print(x is y)  #False-since list is mutable and not reusable
print(x  is  not  y)  #True
print(x == y)  #True
print()  #empty line
m = (1 , 2 , 3 , 4)
n = (1 , 2 , 3 , 4)
print(m  is  n)  #True-since tuple is immuatble and reusable
...
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 4 , 3]
print(x == y)   #False-since list is ordered
a = (4 , 1 , 3 , 2)
b = (4 , 2 , 3 , 1)
print(a == b)  #False-since tuple is ordered
p = {1 , 2 , 3 , 4}
q = {4 , 1 , 3 , 2}
print(p == q)  #True-since set is unordered
m = range(5)
n = range(5)
print(m == n)  #True
...
print(--a)  #25  -(-a)=-(-25)=+25=25
print(a--)  #error  (25-)-=25+
print(a--1)  #26     (25-)-1=25+1=26
print(-a)  #-25
print(+-a) #-25  +(-25)=-25
print(-+a)  #-25  -(+25)=-25
...
print(math . pow(4 , math . pow(3 , 2)))  #262144     4^(3^2)=4^9
...
print(math . sqrt(3+4j))  #error-we cant find sqrt of complex
print(math . sqrt(math . sqrt(256)))  #4   16->4
print(math . sqrt(math . pow(3 , 4)))  #9  sqrt(81)=9
print(math . sqrt(-16))  #error-cannot be determined
print(sqrt(49))  #error-since there is no function named sqrt in the current program
...
print(fabs(-25))  #error-since there is no function named fabs in the current program
...
print(floor(3.5))  #error-since there is no function named floor in the current program
print(ceil(3.5))  #error-since there is no function named ceil in the current program
