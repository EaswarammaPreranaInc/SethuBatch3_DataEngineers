...
try:
	...
	try:
		print('Inner    try')
		print(7 / 0)   --> Raises ZeroDivisonError
		int('Hyd') # Skipped
		'Hyd'[5] # Skipped
		eval('Hyd') # Skipped
...
30
Constructor
# Can't raise MyError becoz it's not child of Exception or BaseException
'''
...
# End of the class
t = Thread()
t . start() # ERROR because object 't' has no start method and is overridden when imported
for  i  in  range(10):
        print('main  thread')
