...
try:
	...
	print('Sec')
	print('Cyb')
#There is no except suite to handle the error and try-except are dependent of each other
...
# Identify  error  (Home  work)
        ...
        print('Sec')
        print('Cyb')
#there is no try suite to execute the statements present inside the except statements
