...
print(???)
print('Each  inner  list   of   outer  list  without  indexes')#print(a[2][1]) 
...
print()
for  x , y ,  z  in   a:
	print(x , y , z , sep = '...')#  Find  outputs (Home  work)
a = [[10 , 20] , [30 , 40 , 50] , [60 , 70 , 80 , 90]]
for  x  in  a:
	print(x)
for  x , y  in  a:
	print(x , y ,	sep = '...')
[3/13, 12:30 PM] SRINIVAS Sir Maths: #  Find  outputs  (Home  work)
a = [[]]
...
print(a)
[3/13, 12:59 PM] SRINIVAS Sir Maths: # Write  a  program  to  create  a  list  with  cubes  of  2 , 4 , 6 , 8 , 10  with  list  comprehension (Home  work)
[3/13, 1:00 PM] SRINIVAS Sir Maths: '''
(Home  work)
...
'''
[3/13, 1:01 PM] SRINIVAS Sir Maths: '''
(Home  work)
...
Output :  ['H' , 'P' , 'C' , 'V']
'''
[3/13, 1:02 PM] SRINIVAS Sir Maths: '''
...
'''
[3/13, 1:03 PM] SRINIVAS Sir Maths: '''
(Home  work)
Repeat   previous  program  with  comprehension
...
'''
[3/13, 1:04 PM] SRINIVAS Sir Maths: '''
(Home  work)
Repeat   previous  program  with  comprehension
...
'''
[3/13, 1:05 PM] SRINIVAS Sir Maths: '''
...
'''
[3/13, 1:06 PM] SRINIVAS Sir Maths: '''
(Home  work)
Repeat   previous  program  with  comprehension
...
'''
[3/13, 1:07 PM] SRINIVAS Sir Maths: '''
(Home  work)
Repeat   previous  program  with  comprehension
...
Output :  [20 , 18 , 32]
'''
[3/13, 1:07 PM] SRINIVAS Sir Maths: #  Write   a  program  to  print  even  numbers  between  1  and  20  with  comprehension
[3/13, 1:09 PM] SRINIVAS Sir Maths: '''
Write  a  program  to  print  those  squares  of  1 , 2 , 3 , 4 , ... 20  which  are  divisible   by  2  with  comprehension

What  is  the  output ?  ---> [4 , 16 , 36 , ... ,  400]
'''
[3/13, 1:11 PM] SRINIVAS Sir Maths: '''
...
'''
[3/13, 1:12 PM] SRINIVAS Sir Maths: '''
...
What  is  the  output ?  --->  [10 , 20 , 30 , 40 , 50 , 60 , 70 , 80 , 90]
'''
[3/13, 1:14 PM] SRINIVAS Sir Maths: # Find  outputs (Home  work)
a = [[10 , 20] , [30 , 40 , 50] , [60 , 70 , 80 , 90]]
b = [ x  for  x  in  a  for  y  in  x]
print(b)#[[10,20],[30,40,50],[60,70,80,90],
 [10,20],[30,40,50],[60,70,80,90],
 [10,20],[30,40,50],[60,70,80,90]]
[3/13, 1:15 PM] SRINIVAS Sir Maths: #  Nested  comprehension  demo  program (Home  work)
