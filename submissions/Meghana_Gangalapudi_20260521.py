...
a . m1() # child thread gets prints 10 times
for  i  in  range(10):
	print('main  thread')#'main thread gets printed 10 times
...
class   Thread:
        def   run(self):
                for  i  in  range(10):
                        print('Child  Thread')
from  threading  import  Thread
t = Thread()# obj is created for the imported thread class 
t . start()#default target is the run method of thread class
for  i  in  range(10):
        print('Main  Thread')#Main thread gets printed 10 times 
...
# End  of  the  class
child = MyThread()
child .  run()# child thread gets printed 10 times
for  i  in  range(10):
        print('main  thread')#Main Thread gets printed 10 times
...
new . start()  
for  i  in  range(10):
	print('Main  Thread')#Main  Thread gets printed 10 times(same for every run)
