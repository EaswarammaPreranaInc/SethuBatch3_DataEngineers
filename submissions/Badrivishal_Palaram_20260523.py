...
12) What  are  the  outputs  for  t12 . start() ?  ---> m1  method  of  class  c1  10 times

13) What  are  the  outputs  for  t13 . start() ?  ---> f1 function 10 times
'''
...
2) What  are  the  outputs  when  start()  method  is  overridden  ?  
from  threading  import  *
class  MyThread(Thread):
	def   start(self):
		super() . start()
...
print("Modified Thread Name :", t.name) #How  to  print  new  name  of  new  thread
print("Number of Threads :", active_count()) #How  to  print  number  of  threads  under  execution
#Main Thread Name : MainThread
New Main Thread Name : Hyd
New Thread Name : Sec
Modified Thread Name : Cyb
Number of Threads : 1
...
print("Main Thread Name :", current_thread().name) #How  to  print  name  of  main  thread
print("t1 Thread Name :", t1.name) #How  to  print  name  of  thread  t1
print("t2 Thread Name :", t2.name) #How  to  print  name  of  thread  t2
...
print("Modified Main Thread Name :", current_thread().name) #How  to  print name  of  main  thread
print("Modified t1 Thread Name :", t1.name) #How  to  print  name  of  thread  t1
print("Modified t2 Thread Name :", t2.name) #How  to  print  name  of  thread  t2
print("Number of Threads :", active_count()) #How  to  print  number  of  threads  under  execution
#Main Thread Name : MainThread
t1 Thread Name : Hyd
t2 Thread Name : Thread-1
Modified Main Thread Name : India
Modified t1 Thread Name : Sec
Modified t2 Thread Name : Cyb
Number of Threads : 1
...
t1 . start() 
t2 . start()
#Rama  guess  54   in  attempt  :  1
Rama  guess  27   in  attempt  :  2
Rama  guess  23   in  attempt  :  3
Rama  guess  75   in  attempt  :  4
Rama  finish  in  4  attempts
Sita  guess  54   in  attempt  :  1
