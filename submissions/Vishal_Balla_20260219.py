...
print(-18 // 4) #previous integer - (-4.5) --> (-5)
print(-(18 // 4))  #after integer - (-4.5) --> (-4)
...
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 3 , 4]
print(x is y)  # False  becoz list is mutable and not reusable so the reference could changed
...
print(math . sqrt(math . sqrt(256))) --> 16  # 4.0
