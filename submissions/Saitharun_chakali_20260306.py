...
a = 'Rama Rao'
print(a [ : 7 : 2])    # String from indexes 0 to 7 in steps of 2 i.e Rm<space>a
print(a [ : 7])        # String from indexes 0 to 7 in steps of 1 i.e Rama Rao
print(a [2 : 4])       # String from indexes 2 to 4 in steps of 1 i.e ma<space>
print(a [2 : ])        # String from indexes 2 to 7 in steps of 1 i.e ma<space>Rao
print(a [ : 4 ])       # String from indexes 0 to 4 in steps of 1 i.e Rama
print(a [ : : 2])      # a[0 : 8 : 2]   --->  string  from  indexes  0  to  7  in  steps  of  2  i.e. Rm<space>a
print(a [-6 : -1])     # string from indexes -6 to -1 in steps of 1 i.e ma ra
print(a [-6 : ])       # string from indexes -6 to 7 in steps of 1 i.e ma Rao
print(a [: -4 : -1])   # string from indexes -1 to -3 in steps of -1 i.e o
print(a [-3 : -1])     # string from indexes -3 to -1 in steps of 1 i.e Ra
...
print(a [2 : 8 : -1])  # string from indexes -1 to -5 in steps of -1 i.e oa
print(a [ : -6 : -1])  # string from indexes -1 to -5 in steps of -1 i.e oa
print(a [2 : -3])      # string from indexes 2 to -3 in steps of 1 i.e ma
print(a [1 : 6 : 2])   # string from indexes 1 to 6 in steps of 2 i.e aaR
print(a [ : -5 : -5])  # string from indexes -1 to -5 in steps of -5 i.e o
print(a [2 : -5])      # start index greater than stop so result is empty string i.e ''
print(a [2 : -5 : 2])  # invalid range with step 2 so result is empty string i.e ''
