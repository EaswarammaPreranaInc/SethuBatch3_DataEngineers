...
try:
	print('try')
else:    # Error because there is no except suite
    print('else')
finally:
    print('finally')
print('End')
...
try:
	...
	print('else1')
else:  #Error because there should be only one else 
	print('else2')
finally:
	print('finally')
print('end')
...
try:
	...
	print('else')
except:  # Error because else should be always between except and finally 
	print('except')
finally:
	print('finally')
print('end')
...
22)
1) What  is  the  output  when  input  is  24 ?  ---> ' ' <next line> end
