...
print(range(4) | range(5)) #error- range can never be concatinated
print([10 , 20]  |  [30 , 20]) #error-list can be concatinated with + operator 
...
# Find outputs
print(7 / 0) #error-can't be divided by zero
print(7 // 0)#error -can't be divided by zero
print(7 % 0) #error-can't be divided by zero
# ** operator demo program
print(3 ** 4)  #   3 ^ 4 = 81
...
print(3 + 4 * 5 - 32 / 2 ** 3) #(3+1024-32/8)=(1027/8)= 128.375
...
z = x + y * 6 #34
print(z) #34
25 = a #error-int cannot be reference
a + b = x + y#error- a+b is not reference
...
a = 20
a %= 3 + 2 * 4 
print(a)#a=a%(3+2*4)=20%(3+8)=20%11=9

# Find outputs (Home work)
a = 3
a **= 4 #a=a**4
print(a) #a=3**4=3^4=81
...
print(a  is  not  b)#False
print(a == b)#True
print()#error-no function is given
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 3 , 4]
print(x is y)#False
print(x  is  not  y)#True
print(x == y)#False
print()#error- print returns nothing
m = (1 , 2 , 3 , 4)
n = (1 , 2 , 3 , 4)
print(m  is  n)#True
...
print(math . pow(10 , -2))#10^-2=1/100
print(math . pow(4 , math . pow(3 , 2)))#4^3^2=4^9=65536
