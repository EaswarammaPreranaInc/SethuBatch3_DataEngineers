...
#a[4] = 32                       # Error Range Obj is immutuable
#print(a * 2)                    # Error
...
a . remove('25')   # Error the element is not in a
print(a)           # [25,10.8,True] 
...
#     0    1    2    3     4
a = [10 , 20 , 30 , 40 , 50]
print(a , id(a))              # [10,20,30,40,50] address of obj list a
a[1 : 4] = [60 , 70]    
print(a , id(a))              # [10,60,70,50] address of obj list a
a[2: 4] = [100,200,300]  
print(a , id(a))              # [10,60,100,200,300] address of obj list a


12.#Find  outputs  (Home  work)
a =  [25]
print(a[1])  # it gives Error becoz index is out of range
print(a[1:]) # []
