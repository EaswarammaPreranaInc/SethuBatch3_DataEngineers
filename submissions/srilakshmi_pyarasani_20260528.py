...
p . start() #executes f1(buf)
c . start() #executes f2(buf)
...
producer stores 6
consumer retrieves 6 
producer stores 7
consumer retrieves 7
producer stores 8
consumer retrieves 8 
producer stores the value and sleeps then consumer retrieves the value and sleep this process happens simultaneously until we press fn+B or ctrl + Break to stop execution.