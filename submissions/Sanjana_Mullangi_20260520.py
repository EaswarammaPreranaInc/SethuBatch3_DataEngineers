...
try:
    ...
    print('finally')
print('End') # Error due to else becoz there is no except suite
...
try:
	...
	print('finally')
print('end') # Error due to else suite becoze more than one else suite
...
try:
	...
	print('finally')
print('end') # Error due to else suite cnnot be print before except suite
