...
3) What  are  the  outputs  for  t3 . start() ?  ---> nothing as empty run method of Thread class is executed
...
7) What  are  the  outputs  for  t7 . start() ?  ---> nothing as empty run method of Thread class is executed

8) What  are  the  outputs  for  t8 . start() ?  ---> m1 method of class c1
...
11) What  are  the  outputs  for  t11 . start() ?  ---> nothing as empty run method of Thread class is executed

12) What  are  the  outputs  for  t12 . start() ?  ---> m1 method of MyThread class
...
new = Thread(name = 'Sec') # How  to  create  a  new  thread  with  name  "Sec"
print(new . name) # How  to  print  name  of  new  thread
new . name = 'Cyb' # How  to  modify  name  of  new  thread  to   'Cyb'
print(new . name) # How  to  print  new  name  of  new  thread
print(current_thread() . name) # How  to  print  number  of  threads  under  execution
...
child = Thread(target = f1 , name = 'child')
...
Sec : 20
Both infinite times
Output order cannot be predicted because there are multiple threads
'''
...
t2 . start()
'''
Rama guess (random number) in attempt: 1
So on until randint is 75
Rama finish in {ctr} attempt
Sita guess (random number) in attempt: 2
So on until randint is 50
Sita finish in {str} attempt
