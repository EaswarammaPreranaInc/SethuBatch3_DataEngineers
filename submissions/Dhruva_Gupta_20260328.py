...
print( lambda   x  :  x * x(7)) #type and id
print( lambda   x  :   x * x) #type and id
...
print(lambda  x , y : x + y  ('Hyder'  ,  ‘abad')) #type and id
...
#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s)) #class and id
print(lambda  x  :  print(x) (s)) #class and id
...
Hyd
Sec
Error as list can have only function inside it and not function
...
#  End  of  the  function		
lamb = f1(3)
print(type(f1)) #class fucntion
print(type(lamb)) #class function
print(lamb(2)) #9
print(lamb(5)) #243
print(lamb) #class and id
print(lamb()) #Error
