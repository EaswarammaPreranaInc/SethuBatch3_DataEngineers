...
# 	print('Sec')
# 	print('Cyb')
# when we use try suite except suite is also mandatory. to overcome this issue initalize except suite

#================================================================================================================================

# Find  outputs  (Home  work)
# print(7 / 0)        # Error , it raises ZeroDivision Error
try:
	print(7 / 0)  
...
# without try suite we cannot intialize except suite
...
try:
        ...
        print('Two')
        print('Three')
# print('Four')         # Error , print function must be in try suite or except suite
except:
		print('Five')
		print('Six')
		print('Seven')
...
try:
	print('try suite')
# except:                     # default except suite must be intialize at last.
...
# except:                           # multiple except suite are not permitted
...
import  math
# print(int('10.8'))      # error , cannot convert string float to int
# print(float('Ten'))     # error
# print(complex('True'))  # error
print(bool('Ten'))      # True , bool(non-empty) = True
print(bool(''))         # False , bool(empty) = False
...
print(a)       # 25
del  a   
# print(a)        # Error , becoz reference is deleted then object is also deleted
print(eval("   'Ten'   "))  # Ten
# print(eval('Ten'))        # Ten , string must have " '' "
...
# print(len(25))        # error
s = {10 , 20 , 15 , 18}
# print(s[0])             # set is unordered , indexing is not possible
# b = {[10 , 20] : [30 , 40]}  # error , becoz keys must be immutable
# print(int(3 + 4j))      # error , argument cannot be complex
# print(int([10 , 20 , 30]))    # error , argument cannot be list  
...
print(a['G'])       # Green
# print(a['Y'])       # error , becoz there is no key = 'Y' 
...
# print(s[4])         # error 
d = {10 : 'Hyd' , 20 : 'Sec'}
# print(d[0])         # error , in dictionary indexing are made by using keys
