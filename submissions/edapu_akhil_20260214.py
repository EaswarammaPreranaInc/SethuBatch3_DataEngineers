...
a = (25)
print(a) # error because if there is one element enclosed in parenthesis after element there should be comma so that pvc consider that as tuple now there is no comma after value so error.
