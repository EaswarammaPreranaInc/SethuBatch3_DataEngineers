...
def  denom(n):
	b=[] #How  create  a  list
	for i in range(len(a)): #How  to  store  9  results  in  list  with  for  loop
		q=n//a[i]
		b.append(q)
		n%=a[i]
...
d=denom(n) #How  to  call  denom()  function
print(d) #How  to  print  non-zero  elements  of  list  and  also  elements  of  list  'a'
